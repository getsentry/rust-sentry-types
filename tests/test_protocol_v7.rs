        ...
        exceptions: vec![
            v7::Exception {
                ...
                stacktrace: Some(v7::Stacktrace {
                    ...
                    registers: {
                        let mut m = v7::Map::new();
                        m.insert("x8".into(), v7::Addr(0x0));
                        m.insert("x20".into(), v7::Addr(0x1));
                        m.insert("x21".into(), v7::Addr(0x1));
                        m.insert("x28".into(), v7::Addr(0x17025f650));
                        m.insert("x4".into(), v7::Addr(0x1702eb100));
                        m.insert("x24".into(), v7::Addr(0x1b1399c20));
                        m.insert("sp".into(), v7::Addr(0x16fd75060));
                        m.insert("x1".into(), v7::Addr(0x1b1399bb1));
                        m.insert("x23".into(), v7::Addr(0x1afe10040));
                        m.insert("x14".into(), v7::Addr(0x1));
                        m.insert("x19".into(), v7::Addr(0x0));
                        m.insert("x18".into(), v7::Addr(0x0));
                        m.insert("x3".into(), v7::Addr(0x1));
                        m.insert("pc".into(), v7::Addr(0x18a310ea4));
                        m.insert("x7".into(), v7::Addr(0x0));
                        m.insert("x10".into(), v7::Addr(0x57b));
                        m.insert("x6".into(), v7::Addr(0x0));
                        m.insert("x13".into(), v7::Addr(0x1));
                        m.insert("x2".into(), v7::Addr(0x1));
                        m.insert("x27".into(), v7::Addr(0x1));
                        m.insert("x26".into(), v7::Addr(0x191ec48d1));
                        m.insert("x9".into(), v7::Addr(0x1b1399c20));
                        m.insert("x29".into(), v7::Addr(0x16fd75060));
                        m.insert("x5".into(), v7::Addr(0x1702eb100));
                        m.insert("fp".into(), v7::Addr(0x16fd75060));
                        m.insert("x0".into(), v7::Addr(0x1));
                        m.insert("lr".into(), v7::Addr(0x18a31aadc));
                        m.insert("x25".into(), v7::Addr(0x0));
                        m.insert("x16".into(), v7::Addr(0x18a31aa34));
                        m.insert("x11".into(), v7::Addr(0x1b3b37b1d));
                        m.insert("cpsr".into(), v7::Addr(0x20000000));
                        m.insert("x17".into(), v7::Addr(0x0));
                        m.insert("x15".into(), v7::Addr(0x881));
                        m.insert("x22".into(), v7::Addr(0x1b1399bb0));
                        m.insert("x12".into(), v7::Addr(0x1b3b37b1d));
                        m
                    },
                    ..Default::default()
                }),
